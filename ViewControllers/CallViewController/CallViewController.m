...
@interface CallViewController ()<UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, QBRTCClientDelegate>
//{
//    NSNumber *USER_id;
//}
...
//    if([[self stringWithTimeDuration:self.timeDuration]isEqual:@"1:00"]){
//        [self session:self.session hungUpByUser:USER_ID userInfo:@{@"hangup" : @"hang up"}];
//        [self session:self.session connectionClosedForUser:USER_ID];
//        [self sessionWillClose:self.session];
//    
//        
//    }
//    
